...
export default class Carousel {
  ...
  render() {
    //general branch - osnovnaja vetka
    ...
    //funkzii dlja raboti s slijdami
    this.sub('inner').append(...slides);
    //kontroler dlja pokaza knopak left/right
    this.update();
  }
  //knomka plus dlja dobovlenie "product-add"
     addCard(event) {
